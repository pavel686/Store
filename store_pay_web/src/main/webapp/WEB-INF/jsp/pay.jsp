...
<html>
  ...
  <body>
     <form action="/pay/pay.html" method="post">
      	<table width="60%">
			<tr>  
				<td bgcolor="#F7FEFF" colspan="4">
			 		订单号：<INPUT TYPE="text" NAME="orderid" value="${orderId}" readonly="readonly"> 
			 		支付金额：<INPUT TYPE="text" NAME="money" value="${pay_price}" readonly="readonly" size="6">元
			 	</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
