...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="payment" value="<fmt:formatNumber groupingUsed="true" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/100+10 }"/>"/>
	<input type="hidden" name="orderShipping.receiverName" value="陈宇"/>
	...
	<input type="hidden" name="orderShipping.receiverAddress" value="北京市昌平区蓝天科技大厦"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>cblue&nbsp;&nbsp;&nbsp;&nbsp;15800888888&nbsp;&nbsp;&nbsp;&nbsp;北京市&nbsp;&nbsp;昌平区&nbsp;&nbsp;蓝天科技大厦</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>圆通速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
